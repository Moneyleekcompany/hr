...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 mb-4 mb-3">
    ...
    <div class="mb-4">
        <button type="submit" class="btn btn-primary">{{isset($eventDetail) ? __('index.update') : __('index.create')}}</button>
        <button type="submit" id="withEventNotification" class="btn btn-primary mx-2">
